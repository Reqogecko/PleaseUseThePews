...
static class SpectatorCellPatch
{
    private static float MaxDistanceToPartySpot = SettingsConfig.GatheringRange;
    private static int NewMaxNum = SettingsConfig.GenRadialTilesToCheck;
